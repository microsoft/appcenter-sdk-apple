...
#pragma unused(target, flags)
  ...
  NSCAssert([(__bridge NSObject *)info isKindOfClass:[SNM_Reachability class]],
            @"info was wrong class in ReachabilityCallback");

  SNM_Reachability *noteObject = (__bridge SNM_Reachability *)info;
...
@implementation SNM_Reachability {
  SCNetworkReachabilityRef _reachabilityRef;
}

+ (instancetype)reachabilityWithHostName:(NSString *)hostName {
  SNM_Reachability *returnValue = NULL;
