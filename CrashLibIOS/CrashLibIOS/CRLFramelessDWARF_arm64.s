...
.text
.align 2
.globl _CRLFramelessDWARF_test
_CRLFramelessDWARF_test:
    stp     x20, x19, [sp, #-16]!
LT1_sub_sp:
    mov     x19, fp     ; Save FP
    mov     x20, lr     ; Save LR
    ...
    bl      _CRLFramelessDWARF_test_crash ; Trigger crash
    ldp     x20, x19, [sp], #16
...
.macro fde_header
.globl _CRLFramelessDWARF_$1.eh
_CRLFramelessDWARF_$1.eh:
LSFDE$0:
.set Lset0$0,LEFDE$0-LASFDE$0
.long Lset0$0 ; FDE Length
LASFDE$0:
.long	LASFDE$0-EH_frame1 ; FDE CIE offset
.quad	_CRLFramelessDWARF_$1-. ; FDE initial location
.set Lset1$0,LT$0_end-_CRLFramelessDWARF_$1
.quad Lset1$0 ; FDE address range
.byte	0x0 ; uleb128 0x0; Augmentation size
.byte	0x4 ; DW_CFA_advance_loc4
.set Lset2$0,LT$0_sub_sp-_CRLFramelessDWARF_$1
.long Lset2$0
...
;   "could not create compact unwind for _CRLFramelessDWARF_test: saved registers do not fit in stack size"
