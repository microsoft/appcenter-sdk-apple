 ...
 * 3. When an MSACAppleErrorLog must be generated, a corresponding MSACWrapperException file is searched for, and if found, its MSACException
 * property is added to the MSACAppleErrorLog. The file is not deleted because there is an additional "data" property that contains
...
/**
 * Save the MSACWrapperException to the file "last_saved_wrapper_exception". This should only be used by a wrapper SDK; native code has no use
 * for it.
 */
