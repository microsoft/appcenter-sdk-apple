...
# App Center Build doesn't support tvOS yet
#$APP_CENTER_CLI_COMMNAD build queue --token $APP_CENTER_ACCESS_TOKEN --branch $BUILD_SOURCEBRANCHNAME --app $APP_CENTER_SASQUATCHTVOBJC_BUILD_APP_ID
#$APP_CENTER_CLI_COMMNAD build queue --token $APP_CENTER_ACCESS_TOKEN --branch $BUILD_SOURCEBRANCHNAME --app $APP_CENTER_SASQUATCHTVSWIFT_BUILD_APP_ID
