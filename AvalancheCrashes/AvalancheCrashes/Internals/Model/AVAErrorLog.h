...
/* Corresponds to the number of milliseconds elapsed between the time the app was launched and the log was sent. [optional]
 */
...
/* Binaries associated to the crash with their associated addresses (used only on iOS to symbolicate the stacktrace). [optional]
 */
