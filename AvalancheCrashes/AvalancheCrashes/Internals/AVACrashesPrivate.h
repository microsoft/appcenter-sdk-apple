...
/**
 * This structure contains callbacks supported by `AVACrashes` to allow the host application to perform
...
/**
 * A file used to indicate that a crash which occured in the last session is currently written to disk.
 */
