...
This version contains an improvement and a bug fix.

### MobileCenter

* **[Improvement]** The SDK extends background time when the application is backgrounded as a last chance to send any remaining logs.
