...
* **[Feature]** `setRemoteOperationDelegate` method to set a delegate to be notified of a pending operation being executed when a client device goes from offline to online.
