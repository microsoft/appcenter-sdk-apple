...
#if DEBUG
  [MSMobileCenter start:@"3ccfe7f5-ec01-4de5-883c-f563bbbe147a" withServices:@[[MSAnalytics class], [MSCrashes class]]];
#else
...
- (NSArray<MSErrorAttachmentLog *> *)attachmentWithCrashes:(MSCrashes *)crashes
  ...
  MSErrorAttachmentLog *attachment2 = [MSErrorAttachmentLog attachmentWithBinaryData:data filename:nil contentType:@"text/xml"];
