...
/**
 * Allocate and initialize a semantic versioning pre-release identifier object by parsing its string form.
 *
...
/**
 * Initialize a semantic versioning pre-release identifier object by parsing its string form.
 *
 * @param identifier A string representing a pre-release identifier.
 *
 * @return An instance of a semantic versioning pre-release identifier object.
