...
- (void)authTokenContext:(__unused MSAuthTokenContext *)authTokenContext refreshAuthTokenForAccountId:(__unused NSString *_Nullable)accountId {
  [self.delegate appCenter:[MSAppCenter sharedInstance]
    acquireAuthTokenWithCompletionHandler:self.authTokenCompletionHandler];
}
