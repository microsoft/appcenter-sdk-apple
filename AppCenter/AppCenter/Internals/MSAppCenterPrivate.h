...
@property(nonatomic) MSAppCenterIngestion *ingestion;
 ...
 * Configure the SDK.
 *
 * @param appSecret A unique and secret key used to identify the application for
 * App Center ingestion.
 * @param transmissionTargetToken A unique and secret key used to identify the
 * application for One Collector ingestion.
 * @param fromApplication A flag indicating that the sdk is configured from an
 * application.
 *
