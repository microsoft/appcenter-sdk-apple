...
/**
 * Method to transform a log into one or several common schema logs. If the log has multiple transmission target tokens, the conversion will produce one log
 * per token.
 *
