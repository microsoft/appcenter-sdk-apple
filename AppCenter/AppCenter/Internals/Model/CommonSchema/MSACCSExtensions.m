...
#define MSACLOG_VALIDATE_OPTIONAL_OBJECT(fieldName) MSACLOG_VALIDATE(fieldName, self.fieldName == nil || [self.fieldName isValid])
  return MSACLOG_VALIDATE_OPTIONAL_OBJECT(metadataExt) && MSACLOG_VALIDATE_OPTIONAL_OBJECT(protocolExt) &&
         MSACLOG_VALIDATE_OPTIONAL_OBJECT(userExt) && MSACLOG_VALIDATE_OPTIONAL_OBJECT(deviceExt) && MSACLOG_VALIDATE_OPTIONAL_OBJECT(osExt) &&
         MSACLOG_VALIDATE_OPTIONAL_OBJECT(appExt) && MSACLOG_VALIDATE_OPTIONAL_OBJECT(netExt) && MSACLOG_VALIDATE_OPTIONAL_OBJECT(sdkExt) &&
         MSACLOG_VALIDATE_OPTIONAL_OBJECT(locExt);
}
