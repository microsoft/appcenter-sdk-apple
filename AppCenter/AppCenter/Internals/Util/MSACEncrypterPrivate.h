...
static NSString *const kMSACEncryptionKeyTagAlternate = @"kMSACEncryptionKeyTagAlternate";
static NSString *const kMSACEncryptionKeyTagOriginal = @"kMSACEncryptionKeyTag";
