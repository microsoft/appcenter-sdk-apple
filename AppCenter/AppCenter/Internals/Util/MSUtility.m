...
static ms_info_t appcenter_library_info
    __attribute__((section("__TEXT,__ms_ios,regular,no_dead_strip"))) = {
        .info_version = 1,
...
__attribute__((used)) static void importCategories() {
  [NSString
      stringWithFormat:@"%@ %@ %@ %@ %@ %@", MSUtilityApplicationCategory,
                       MSUtilityEnvironmentCategory, MSUtilityDateCategory,
                       MSUtilityStringFormattingCategory, MSUtilityFileCategory,
                       MSUtilityPropertyValidationCategory];
}
