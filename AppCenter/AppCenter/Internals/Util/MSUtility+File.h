...
/**
 * Creates a file inside the app center sdk's file directory, intermediate
 * directories are also create if nonexistent.
 *
 * @param filePathComponent A string representing the path of the file to
 * create.
 ...
 *
 * @return The URL of the file that was created. Necessary for e.g. crash
 * buffer.
 *
 * @discussion SDK files should not be backed up in iCloud. Thus, iCloud backup
 * is explicitely deactivated on every folder created.
 */
 ...
 *
 * @param itemPathComponent A string representing the path of the file to
 * delete.
 *
 * @return YES if the item was removed successfully or if URL was nil. Returns
 ...
 * directories are also created if nonexistent.
 *
 * @param directoryPathComponent A string representing the path of the directory
 * to create.
 *
 * @return `YES` if the operation was successful or if the item already exists,
 * otherwise `NO`.
 *
 * @discussion SDK files should not be backed up in iCloud. Thus, iCloud backup
 * is explicitely deactivated on every folder created.
 ...
 *
 * @param filePathComponent A string representing the pathComponent of the file
 * to read.
 *
 ...
 *
 * @param directory A string representing the path of the directory to look for
 * content.
 *
 ...
 *
 * @return `YES` if a file or existence exists at the specified location.
 * Otherwiese `NO`.
 */
 ...
 *
 * @param filePathComponent A string representing the path component of the file
