 ...
 * applications.
 *
 * @param sizeInBytes Maximum size in bytes. This will be rounded up to the nearest multiple of page size (default is 4096 bytes). Values
 * below 20,480 bytes (20 KiB) will be ignored.
 *
