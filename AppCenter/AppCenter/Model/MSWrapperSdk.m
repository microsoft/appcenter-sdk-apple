...
- (BOOL)isEqual:(id)object {
  ...
  return ((!self.wrapperSdkVersion && !wrapperSdk.wrapperSdkVersion) ||
          [self.wrapperSdkVersion
              isEqualToString:wrapperSdk.wrapperSdkVersion]) &&
         ...
         ((!self.wrapperRuntimeVersion && !wrapperSdk.wrapperRuntimeVersion) ||
          [self.wrapperRuntimeVersion
              isEqualToString:wrapperSdk.wrapperRuntimeVersion]) &&
         ((!self.liveUpdateReleaseLabel &&
           !wrapperSdk.liveUpdateReleaseLabel) ||
          [self.liveUpdateReleaseLabel
              isEqualToString:wrapperSdk.liveUpdateReleaseLabel]) &&
         ((!self.liveUpdateDeploymentKey &&
           !wrapperSdk.liveUpdateDeploymentKey) ||
          [self.liveUpdateDeploymentKey
              isEqualToString:wrapperSdk.liveUpdateDeploymentKey]) &&
         ((!self.liveUpdatePackageHash && !wrapperSdk.liveUpdatePackageHash) ||
          [self.liveUpdatePackageHash
              isEqualToString:wrapperSdk.liveUpdatePackageHash]);
}
...
- (instancetype)initWithCoder:(NSCoder *)coder {
  ...
  if (self) {
    ...
    _wrapperRuntimeVersion =
        [coder decodeObjectForKey:kMSWrapperRuntimeVersion];
    _liveUpdateReleaseLabel =
        [coder decodeObjectForKey:kMSLiveUpdateReleaseLabel];
    _liveUpdateDeploymentKey =
        [coder decodeObjectForKey:kMSLiveUpdateDeploymentKey];
    _liveUpdatePackageHash =
        [coder decodeObjectForKey:kMSLiveUpdatePackageHash];
  }
  return self;
}
...
- (void)encodeWithCoder:(NSCoder *)coder {
  ...
  [coder encodeObject:self.wrapperRuntimeVersion
               forKey:kMSWrapperRuntimeVersion];
  [coder encodeObject:self.liveUpdateReleaseLabel
               forKey:kMSLiveUpdateReleaseLabel];
  [coder encodeObject:self.liveUpdateDeploymentKey
               forKey:kMSLiveUpdateDeploymentKey];
  [coder encodeObject:self.liveUpdatePackageHash
               forKey:kMSLiveUpdatePackageHash];
}
