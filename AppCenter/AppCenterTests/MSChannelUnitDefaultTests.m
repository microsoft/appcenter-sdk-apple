...
- (void)testLogsSentWithSuccess {
  ...
  OCMStub([storageMock saveLog:OCMOCK_ANY withGroupId:OCMOCK_ANY critical:NO]).andReturn(YES);
  ...
  OCMExpect([delegateMock channel:sut didPrepareLog:enqueuedLog internalId:OCMOCK_ANY flags:MSFlagsNone]);
...
- (void)testDontSaveLogsWhileDisabledWithDataDeletion {
  ...
  [self initChannelEndJobExpectation];
  id mockLog = [self getValidMockLog];
  OCMReject([self.storageMock saveLog:OCMOCK_ANY withGroupId:OCMOCK_ANY critical:NO]);
...
- (void)testDelegateAfterChannelDisabled {
  ...
  [self waitForExpectationsWithTimeout:1
                               handler:^(NSError *error) {
                                 ...
                                 OCMVerify([delegateMock channel:sut didPrepareLog:mockLog internalId:OCMOCK_ANY flags:MSFlagsNone]);
...
- (void)testEnqueuingLogDoesNotPersistFilteredLogs {
  ...
  [self initChannelEndJobExpectation];
  id storageMock = OCMProtocolMock(@protocol(MSStorage));
  OCMReject([storageMock saveLog:OCMOCK_ANY withGroupId:OCMOCK_ANY critical:NO]);
  MSChannelUnitDefault *sut = [[MSChannelUnitDefault alloc] initWithIngestion:self.ingestionMock
                                                                      storage:storageMock
                                                                configuration:self.configMock
                                                            logsDispatchQueue:self.logsDispatchQueue];
  ...
  OCMExpect([delegateMock channel:sut didPrepareLog:log internalId:OCMOCK_ANY flags:MSFlagsNone]);
  OCMExpect([delegateMock2 channel:sut didPrepareLog:log internalId:OCMOCK_ANY flags:MSFlagsNone]);
...
- (void)testEnqueuingLogPersistsUnfilteredLogs {
  ...
  id<MSLog> log = [self getValidMockLog];
  id storageMock = OCMProtocolMock(@protocol(MSStorage));
  OCMExpect([storageMock saveLog:log withGroupId:self.configMock.groupId critical:NO]);
  MSChannelUnitDefault *sut = [[MSChannelUnitDefault alloc] initWithIngestion:self.ingestionMock
                                                                      storage:storageMock
                                                                configuration:self.configMock
                                                            logsDispatchQueue:self.logsDispatchQueue];
  OCMStub([sut.storage saveLog:log withGroupId:OCMOCK_ANY critical:NO]).andReturn(YES);
  id delegateMock = OCMProtocolMock(@protocol(MSChannelDelegate));
...
- (void)testLogsStoredWhenTargetKeyIsPaused {
  ...
  [self waitForExpectationsWithTimeout:1
                               handler:^(NSError *error) {
                                 ...
                                 OCMVerify([self.storageMock saveLog:log withGroupId:self.sut.configuration.groupId critical:NO]);
                               }];
}
