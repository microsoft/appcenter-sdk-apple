...
- (void)testSetCustomPropertiesWithEmptyPropertiesDoesNotEnqueueCustomPropertiesLog {
  ...
  OCMStub([channelUnit enqueueItem:[OCMArg isKindOfClass:[MSCustomPropertiesLog class]] flags:NO]).andDo(nil);
  [MSAppCenter sharedInstance].channelUnit = channelUnit;

  // When
  OCMReject([channelUnit enqueueItem:[OCMArg isKindOfClass:[MSCustomPropertiesLog class]] flags:NO]);
...
- (void)testSetCustomProperties {
  ...
  // Then
  OCMVerify([channelUnit enqueueItem:[OCMArg isKindOfClass:[MSCustomPropertiesLog class]] flags:NO]);
...
- (void)testStartWithoutServices {
  ...
  OCMReject([channelUnit enqueueItem:[OCMArg isKindOfClass:[MSStartServiceLog class]] flags:NO]);
...
- (void)testStartServiceLogIsSentAfterStartService {
  ...
  [MSAppCenter start:MS_UUID_STRING withServices:nil];
  id channelUnit = OCMProtocolMock(@protocol(MSChannelUnitProtocol));
  OCMStub([channelUnit enqueueItem:[OCMArg isKindOfClass:[MSStartServiceLog class]] flags:NO]).andDo(nil);
  [MSAppCenter sharedInstance].channelUnit = channelUnit;
  ...
  // Then
  OCMVerify([channelUnit enqueueItem:[OCMArg isKindOfClass:[MSStartServiceLog class]] flags:NO]);
}
...
- (void)testStartServiceLogWithDisabledCore {
  ...
  OCMStub([channelUnit enqueueItem:[OCMArg isKindOfClass:[MSStartServiceLog class]] flags:NO]).andDo(^(NSInvocation *invocation) {
