...
- (void)testSetCustomPropertiesWithEmptyPropertiesDoesNotEnqueueCustomPropertiesLog {
  ...
  OCMStub([channelUnit enqueueItem:[OCMArg isKindOfClass:[MSCustomPropertiesLog class]] flags:MSFlagsNone]).andDo(nil);
  [MSAppCenter sharedInstance].channelUnit = channelUnit;

  // When
  OCMReject([channelUnit enqueueItem:[OCMArg isKindOfClass:[MSCustomPropertiesLog class]] flags:MSFlagsNone]);
...
- (void)testSetCustomProperties {
  ...
  // Then
  OCMVerify([channelUnit enqueueItem:[OCMArg isKindOfClass:[MSCustomPropertiesLog class]] flags:MSFlagsNone]);
...
- (void)testStartWithoutServices {
  ...
  OCMReject([channelUnit enqueueItem:[OCMArg isKindOfClass:[MSStartServiceLog class]] flags:MSFlagsNone]);
...
- (void)testStartServiceLogIsSentAfterStartService {
  ...
  [MSAppCenter start:MS_UUID_STRING withServices:nil];
  id channelUnit = OCMProtocolMock(@protocol(MSChannelUnitProtocol));
  OCMStub([channelUnit enqueueItem:[OCMArg isKindOfClass:[MSStartServiceLog class]] flags:MSFlagsNone]).andDo(nil);
  [MSAppCenter sharedInstance].channelUnit = channelUnit;
  ...
  // Then
  OCMVerify([channelUnit enqueueItem:[OCMArg isKindOfClass:[MSStartServiceLog class]] flags:MSFlagsNone]);
}
...
- (void)testStartServiceLogWithDisabledCore {
  ...
  OCMStub([channelUnit enqueueItem:[OCMArg isKindOfClass:[MSStartServiceLog class]] flags:MSFlagsNone]).andDo(^(NSInvocation *invocation) {
