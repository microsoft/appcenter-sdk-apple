...
- (void)testRemoteOperationWhenNoDocumentInStoreAndDefaultTTL {
  ...
  [self waitForExpectationsWithTimeout:1
                               handler:^(NSError *error) {
                                 ...
                                 OCMVerify([self.documentStoreMock upsertWithToken:token documentWrapper:remoteDocumentWrapper operation:nil deviceTimeToLive:kMSDataStoreTimeToLiveDefault]);
                               }];
}
...
- (void)testRemoteOperationWhenNoDocumentInStoreAndNoCache {
  ...
  [self waitForExpectationsWithTimeout:1
                               handler:^(NSError *error) {
                                 ...
                                 XCTAssertEqual(wrapper, remoteDocumentWrapper);
                                 OCMReject([[self.documentStoreMock ignoringNonObjectArgs] upsertWithToken:OCMOCK_ANY documentWrapper:OCMOCK_ANY operation:OCMOCK_ANY deviceTimeToLive:0]);
                               }];
}
...
- (void)testRemoteOperationWhenNoDocumentInStoreAndCustomTTL {
  ...
  [self waitForExpectationsWithTimeout:1
                               handler:^(NSError *error) {
                                 ...
                                 XCTAssertEqual(wrapper, remoteDocumentWrapper);
                                 OCMVerify([self.documentStoreMock upsertWithToken:token documentWrapper:remoteDocumentWrapper operation:nil deviceTimeToLive:deviceTimeToLive]);
                               }];
}
...
- (void)testDeleteWhenUnsyncedCreateOperation {
  ...
  __block MSDocumentWrapper *cachedDocumentWrapper = [[MSDocumentWrapper alloc] initWithDeserializedValue:[MSDictionaryDocument alloc] jsonValue:@"" partition:@"partition" documentId:@"documentId" eTag:nil lastUpdatedDate:nil pendingOperation:kMSPendingOperationCreate error:nil];
  __block MSDocumentWrapper *wrapper;
  OCMStub([self.documentStoreMock readWithToken:OCMOCK_ANY documentId:OCMOCK_ANY documentType:OCMOCK_ANY])
    .andReturn(cachedDocumentWrapper);
  MSTokenResult *token = [MSTokenResult alloc];
  __block MSTokensResponse *response = [[MSTokensResponse alloc] initWithTokens:@[ token ]];
...
- (void)testDeleteWhenUnsyncedReplaceOperation {
  ...
  // If
  XCTestExpectation *expectation = [self expectationWithDescription:@"Completed with discarded create or replace operation."];
  __block MSDocumentWrapper *cachedDocumentWrapper = [[MSDocumentWrapper alloc] initWithDeserializedValue:[MSDictionaryDocument alloc] jsonValue:@"" partition:@"partition" documentId:@"documentId" eTag:nil lastUpdatedDate:nil pendingOperation:kMSPendingOperationReplace error:nil];
  __block MSDocumentWrapper *wrapper;
  OCMStub([self.documentStoreMock readWithToken:OCMOCK_ANY documentId:OCMOCK_ANY documentType:OCMOCK_ANY])
  .andReturn(cachedDocumentWrapper);
  MSTokenResult *token = [MSTokenResult alloc];
...
- (void)testReadOperationFailsWhenPendingDelete {
  ...
  // If
  XCTestExpectation *expectation = [self expectationWithDescription:@"Completed with remote document (custom TTL)."];
  __block MSDocumentWrapper *cachedDocumentWrapper = [[MSDocumentWrapper alloc] initWithDeserializedValue:[MSDictionaryDocument alloc] jsonValue:@"" partition:@"partition" documentId:@"documentId" eTag:@"" lastUpdatedDate:nil pendingOperation:kMSPendingOperationDelete error:nil];
  __block MSDocumentWrapper *wrapper;
  OCMStub([self.documentStoreMock readWithToken:OCMOCK_ANY documentId:OCMOCK_ANY documentType:OCMOCK_ANY])
    .andReturn(cachedDocumentWrapper);
  MSTokenResult *token = [MSTokenResult alloc];
...
- (void)testLocalDeleteWhenCachedDocumentPresent {
  ...
  // If
  XCTestExpectation *expectation = [self expectationWithDescription:@"Completed with discarded create or replace operation."];
  __block MSDocumentWrapper *cachedDocumentWrapper = [[MSDocumentWrapper alloc] initWithDeserializedValue:[MSDictionaryDocument alloc] jsonValue:@"" partition:@"partition" documentId:@"documentId" eTag:@"" lastUpdatedDate:nil pendingOperation:nil error:nil];
  __block MSDocumentWrapper *wrapper;
  OCMStub([self.documentStoreMock readWithToken:OCMOCK_ANY documentId:OCMOCK_ANY documentType:OCMOCK_ANY])
  .andReturn(cachedDocumentWrapper);
  MSTokenResult *token = [MSTokenResult alloc];
  ...
  [self waitForExpectationsWithTimeout:1
                               handler:^(NSError *error) {
                                 ...
                                 XCTAssertEqual(wrapper.documentId, cachedDocumentWrapper.documentId);
                                 XCTAssertEqual(wrapper.pendingOperation, kMSPendingOperationDelete);
                                 OCMVerify([self.documentStoreMock upsertWithToken:token documentWrapper:wrapper operation:kMSPendingOperationDelete deviceTimeToLive:kMSDataStoreTimeToLiveDefault]);
                               }];
}
...
- (void)testLocalCreateWhenCachedDocumentPresent {
  ...
  [self waitForExpectationsWithTimeout:1
                               handler:^(NSError *error) {
                                 ...
                                 OCMVerify([self.documentStoreMock upsertWithToken:token documentWrapper:wrapper operation:kMSPendingOperationCreate deviceTimeToLive:kMSDataStoreTimeToLiveDefault]);
                               }];
}
...
- (void)testLocalReplaceWhenCachedDocumentPresent {
  ...
  [self waitForExpectationsWithTimeout:1
                               handler:^(NSError *error) {
                                 ...
                                 NSDictionary *actualDict = [wrapper.deserializedValue serializeToDictionary];
                                 XCTAssertEqual(actualDict[@"key"], @"value");
                                 OCMVerify([self.documentStoreMock upsertWithToken:token documentWrapper:wrapper operation:kMSPendingOperationReplace deviceTimeToLive:kMSDataStoreTimeToLiveDefault]);
                               }];
}
