...
/**
 * Callback method that will be called in case the SDK was able to send an event
 * log to the server. Use this method to provide custom behavior.
 *
 * @param analytics The instance of MSAnalytics.
...
/**
 * Callback method that will be called in case the SDK was able to send a page
 * log to the server. Use this method to provide custom behavior.
 *
 * @param analytics The instance of MSAnalytics.
 ...
 */
- (void)analytics:(MSAnalytics *)analytics
    didSucceedSendingPageLog:(MSPageLog *)pageLog;

/**
 * Callback method that will be called in case the SDK was unable to send a page
 * log to the server.
 *
 * @param analytics The instance of MSAnalytics.
 ...
 */
- (void)analytics:(MSAnalytics *)analytics
    didFailSendingPageLog:(MSPageLog *)pageLog
                withError:(NSError *)error;
